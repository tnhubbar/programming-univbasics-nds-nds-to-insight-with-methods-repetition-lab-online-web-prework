...
def list_of_directors(source)
  ...
  total_directors_index = 0 
  while total_directors_index < source.length do
    total_directors << source[total_directors_index][:name]
    total_directors_index +=1
  end
  total_directors
end
...
def total_gross(source)
  ...
  while name_index < dir_names.length do 
    dir_names = dir_names[name_index]
    grand_total += dir_totals[dir_names]
    name_index +=1 
  end 
   grand_total
